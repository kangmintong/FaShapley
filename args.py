...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Init importance scores according to shapley value",
    )

    parser.add_argument(
        "--shapley_layerwise_finetuning",
        action="store_true",
        default=False,
        help="Init importance scores according to shapley value",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="base",
        choices=("base", "adv", "mixtrain", "ibp", "smooth", "freeadv", "lirpa"),
    ...
    parser.add_argument("--lr_decay_milestones", nargs='+', type=int, default=[600, 700],
                        help='learning rate dacay milestones')
    ...
    parser.add_argument("--scheduler_opts", type=str, default="start=100,length=400,mid=0.4",
    ...
    parser.add_argument("--device_lirpa", type=str, default="cuda", choices=["cpu", "cuda"], help='use cpu or cuda')
