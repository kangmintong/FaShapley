...
class CIFAR10:
    ...
    # kmt: validation dataloader to calculate shapley value
    def shapley_loader(self, **kwargs):
        trainset = datasets.CIFAR10(
            root=os.path.join(self.args.data_dir, "CIFAR10"),
            train=True,
            download=True,
        ...
        self.args.data_fraction = 1000 / len(trainset)
    ...
    def shapley_loader_smooth(self, **kwargs):
        trainset = datasets.CIFAR10(
            root=os.path.join(self.args.data_dir, "CIFAR10"),
            train=True,
            download=True,
