...
#    --trainer $3 --val_method $4 --gpu $5 --k 1.0 --save-dense --dataset CIFAR10 --batch-size 128 \
#     --epochs 200 --schedule_length 120;
    ...
    --source-net /home/zongwei/mintong/tmp/hydra_protocol_3/trained_models/cifar_model-trainer_crown-ibp_new-k_0.01-prunepochs_20/pretrain/latest_exp/checkpoint/checkpoint.pth.tar --epochs $7 \
...
(
    pretrain_prune_finetune  "cifar_model-trainer_crown-ibp_new-k_0.01-prunepochs_20"  $arch  "crown-ibp"   "ibp"  "5"   0.05  30 ;
);